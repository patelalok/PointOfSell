...
public class BarcodeManager {
    ...
    public Document getPdf(String productName, double price, int noOfBarcode) throws IOException, DocumentException {
        ...
        try {
            ...
            //Open output file
            File outputFile = new File("/Users/asp5045/Downloads/PointOfSale/Screen Shot 2016-07-11 at 1.49.18 PM.png");
            ...
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("AddTableExample1.pdf"));
            document.open();
