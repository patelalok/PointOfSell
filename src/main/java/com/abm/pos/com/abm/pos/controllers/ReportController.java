...
public class ReportController {
   ...
   @RequestMapping(value = "/getInventoryByVendor",method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value= "/printYearlySalesReport", method = RequestMethod.GET, produces = "application/pdf")
    public ResponseEntity<byte[]> printYearlySalesReport(@RequestParam String startDate, @RequestParam String endDate, @RequestParam int reportNo) throws IOException, DocumentException {
