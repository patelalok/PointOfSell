...
public class SQLQueries {
 ...
 public String addTransactionPaymentDetail = "INSERT INTO TRANSACTION_PAYMENT " +
   ...
   public String getProductDescription = "SELECT DESCRIPTION FROM PRODUCT WHERE PRODUCT_ID = ?";
    ...
    public String editClosingDetails = "UPDATE CASH_REGISTER SET USER_ID_CLOSE = ? , REPORT_CASH = ? , REPORT_CREDIT = ? , REPORT_TOTAL_AMOUNT = ? CLOSE_CASH = ? , CLOSE_CREDIT = ?, CLOSE_DATE = ?, CLOSE_TOTAL_AMOUNT = ?, CASH_DIFFERENCE = ?, CREDIT_DIFFERENCE = ?, TOTAL_DIFFERENCE = ? , TOTAL_BUSINESS_AMOUNT = ?, TOTAL_TAX = ?, TOTAL_DISCOUNT = ?, TOTAL_PROFIT = ?, TOTAL_MARKUP = ? WHERE REGISTER_ID = ? ";
}
