...
public class SQLQueries {
 ...
 public String addUserQuery
    ...
    public String addOpeningDetails = "INSERT INTO CLOSING_DETAILS " +
            "(USER_ID_OPEN,OPEN_AMOUNT VALUES (?,?)";

    public String addClosingDetails = "UPDATE CASH_REGISTER SET USER_ID_CLOSE = ?, REPORT_CASH = ?, REPORT_CREDIT = ?, REPORT_TOTAL_AMOUNT = ?, " +
            "CLOSE_CASH = ?, CLOSE_CREDIT = ?, CLOSE_DATE = ?, CLOSE_TOTAL_AMOUNT = ?, CASH_DIFFERENCE = ?, CREDIT_DIFFERENCE = ?," +
            "TOTAL_DIFFERENCE = ?, TOTAL_BUSINESS_AMOUNT = ?, TOTAL_TAX = ?, TOTAL_DISCOUNT = ?, TOTAL_PROFIT = ?, TOTAL_MARKUP = ? WHERE OPEN_DATE = ?";
